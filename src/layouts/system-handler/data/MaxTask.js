...
export default function MaxTask() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const feedbackExpiredHour = data.find(item => item.variable === "MaxTaskDelivered");
  ...
  const handleUpdateClick = async () => {
    const configData = {
      id: "1c072362-3188-4a29-a42a-cd1c850d46c5",
      variable: "MaxTaskDelivered",
      value: value,
    };

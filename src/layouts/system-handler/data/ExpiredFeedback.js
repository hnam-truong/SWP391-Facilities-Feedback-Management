...
export default function ExpiredFeedback() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const feedbackExpiredHour = data.find(item => item.variable === "FeedbackExpiredHour");
    ...
    const handleUpdateClick = async () => {
        const configData = {
            id: "47a671ac-4a60-45aa-9d02-e46ac1c3d288",
            variable: "FeedbackExpiredHour",
            value: value,
        };
    ...
    return (
        <div>
            <FormControl sx={{ m: 1, width: '25ch', mt: 9 }} variant="outlined">
                ...
                <Button sx={{ color: 'ButtonFace', mt: 1 }} variant="contained" onClick={handleUpdateClick}>
                    Update
                </Button>
            </FormControl>
